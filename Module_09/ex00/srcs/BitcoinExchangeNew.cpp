...
/*   Updated: 2025/02/16 09:14:43 by amanjon          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	readFileCsv(std::map<std::string, double> &dataTxt)
{
	...
	while (std::getline(file, currentLine))
	{
		...
		std::cout << "resultBtc.first: " << resultBtc.first << std::endl;
		std::cout << "resultBtc.second: " << resultBtc.second << std::endl;
...
void    readFileTxt()
{
	...
	/* for (std::map<std::string, double>::iterator it = dataTxt.begin(); it != dataTxt.end(); ++it)
		std::cout << "dateTxt->first: " << it->first << std::endl << "it->second: " << it->second << std::endl; */
	readFileCsv(dataTxt);
